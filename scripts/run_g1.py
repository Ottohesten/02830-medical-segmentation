...
inference (clean + perturbations) -> TTA -> Dice -> uncertainty scores + heatmaps -> evaluation + figures.
...
from segreview.pipeline import step_dice, step_evaluate, step_inference, step_tta, step_uncertainty
